...
export default function inventoryBaggingReducer(
  ...
  switch (action.type) {
    ...
    case 'INVENTORY_BAG_CONNOTE_LIST_REQUESTED': return state;
    case 'INVENTORY_BAG_CONNOTE_LIST_FULFILLED':
      return {
        ...state,
        activeBag: action.data,
        service: ' ',
        destination: ' ',
        baggingItemList: action.data.bagDetail,
      };
