...
class ItemScene extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <View style={{flex: '1 1 0%',paddingRight: 60,paddingLeft: 60}}>
      ...
      case 'bag': {
        ...
        return (
          <BagList
            ...
            handleEdit={this._handleBagEdit}
            rowsPerPage={rowsPerPage}
            activePage={activePage}
            activeSortColumn={activeSortColumn}
            activeSortType={activeSortType}
  ...
  _handleBagEdit = (bagID) => {
    this.props.history.push(`/inventory/bagging/${bagID}`);
  }
