                        ...
                        .map((n) => {
                          return (
                            <TableRow
                              ...
                              key={n.menifest_no}
                            >
                              <TableCell padding="none">{n.vehicle_type.type_name}</TableCell>
                              ...
                              <TableCell>{n.bag_detail.total_weight}</TableCell>
                              <TableCell>{n.vehicle.police}</TableCell>
                              <TableCell>{n.driver}</TableCell>
                              <TableCell>{n.eta}</TableCell>
                              <TableCell>{n.etd}</TableCell>
                              <TableCell>{n.actual_depart}</TableCell>
                              <TableCell>{n.actual_arrived}</TableCell>
                              {<TableCell>
                                <Button
                                  variant="flat"
                                  dense="true"
