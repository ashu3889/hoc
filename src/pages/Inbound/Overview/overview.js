...
class InboundOverview extends React.Component {
  ...
  componentDidMount() {
    ...
    getEntityList('inbound/prealert', {n: userNodeId})
    getEntityList('inbound/received', {n: userNodeId})
    getEntityList('inbound/traffic', {n: userNodeId})
  }
      ...
      <div className={classes.root}>
        ...
        <div>
          <Grid container>
            ...
            <Grid md={4} item xs={4}>
              <Paper className={classes.formWrapper} style={{marginLeft:20}}>
