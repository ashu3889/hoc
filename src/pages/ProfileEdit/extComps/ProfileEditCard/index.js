...
class ProfileEditCard extends Component {
  ...
  updateEntity = () => {
    ...
    putEntity(`/users/${userId}`, {

      name : this.state.nameProfile,
      email : this.state.emailProfile,
      dob : this.state.dobProfile,
  ...
  render() {
    ...
    return (
      <Paper className={classes.paper}>
        ...
        /> */}
        <br/>
          <Link style={{textDecoration: 'none'}} to={{ pathname: '/myprofile' }} >
        <Button
          variant="raised"
          color="primary"
        ...
        <Button
          ...
          // onClick={() => this.handleCancel('openSummaryDialog');
                  >
          Cancel
        </Button>
        </Link>
