          ...
          <Grid container spacing={24}>
            <Grid md={6} item xs={6} className={classes.overviewWidget}>
              <Paper style={formWrapper} className={classes.formWrapper}>
                <Typography type="title"><strong>Active Courier / All</strong></Typography>
                <br/>
            ...
            <Grid md={6} item xs={6} className={classes.overviewWidget}>
              <Paper style={formWrapper} className={classes.formWrapper}>
                <Typography type="title"><strong>Deliery within SLA / out of SLA</strong></Typography>
                <br/>
                <div style={leftgrahside}>
                  { ((data02.length === 0 && <strong className={classes.infoText}>Not Enough Data</strong>)) || <PieChart width={600} height={260}>
                    <Pie
          ...
          <Grid container spacing={24}>
            <Grid md={6} item xs={6} className={classes.overviewWidget}>
                <Paper style={formWrapper} className={classes.formWrapper}>
                  ...
                  <Grid container>
                  <Grid item xs={6}>
                    <div style={paketStylewrap}><span>Connote Runsheet</span><br />
                    <Typography style={paketStyle} variant="headline" gutterBottom><strong>{boxData.connote_runsheet}</strong></Typography>
                    </div>
                  </Grid>
                  <Grid item xs={6}>
                    <div style={paketStylewrap}><span>Connote Delivered</span><br />
                    <Typography style={paketStyle} variant="headline" gutterBottom><strong>{boxData.connote_delivered}</strong></Typography>
                    </div>
                  </Grid>
                  </Grid>
                  <Grid container>
                  <Grid item xs={6}>
                    ...
                    <Typography style={paketStyle} variant="headline" gutterBottom><strong>{boxData.pod}</strong></Typography>
                    </div>
                  </Grid>
                  <Grid item xs={6}>
