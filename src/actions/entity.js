...
export const deleteEntity = (entity, data) => {
  var config = {
    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
  };
  ...
  return new HttpClient().delete(entity, formBody, config);
};
...
export const putJsonEntity = (entity, data) =>{
  return new HttpClient().put(entity,data);
};