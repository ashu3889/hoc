...
import MenifestCheck from '../pages/Transport/Manifest/form/check';
//=======
//Pickup
...
import PickUpList            from  '../pages/PickUp/List'; 
import PickUpListCreate      from  '../pages/PickUp/List/form';
import PickUpListEdit        from  '../pages/PickUp/List/form/edit';
...
import UploadConnoteForm from '../pages/Upload/Connote';
...
export const routes = [
  ...
  {
    pathName: '/pickup/list',
    Component: PickUpList,
    exact: true,
    headerComponent: Header,
  },
  {
    pathName: '/pickup/list/create',
    Component: PickUpListCreate,
    exact: true,
    headerComponent: Header,
  },
  {
    pathName: '/pickup/list/edit/:id',
    Component: PickUpListEdit,
    exact: true,
    headerComponent: Header,
  },
  {
  ...
  {
    pathName: '/transport/manifest/check/:id',
    Component: MenifestCheck,
    exact: true,
    headerComponent: Header,
  },
  {
  ...
  {
    pathName: '/upload/connote',
    Component: UploadConnoteForm,
    exact: true,
    headerComponent: Header,
  },
  {
